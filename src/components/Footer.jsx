...
export default function Footer() {
  return (
    <div className="bg-zinc-100 flex flex-col md:flex-row justify-around items-center py-5 absolute bottom-0 inset-x-0">
      ...
      <div className="hidden md:flex items-center gap-2">
        <p className="text-zinc-500 text-xl mr-4">Follow us on</p>
