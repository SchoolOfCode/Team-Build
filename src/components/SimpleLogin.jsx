...
export default function SimpleLogin() {
  ...
  return (
    <div className="text-left mx-3 lg:p-10 lg:flex lg:flex-col lg:bg-slate-50 lg:justify-center lg:align-middle lg:text-xl lg:items-center lg:w-7/12 lg:shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] lg:rounded-md">
      ...
      <div>
        <div className="flex flex-row lg:flex-row justify-center lg:gap-20 items-center mb-4">
          <button className="bg-red-400  font-bold rounded w-44 h-10 text-sm lg:w-64 lg:text-md lg:mt-4 m-2">
      ...
      <form
        className="mt-5 tracking-wider flex flex-col "
        method="POST"
      ...
      >
        <div>
          <div>
            <input
              ...
              value={email}
              className="border-b pb-2 border-gray-600 placeholder:text-gray-600 placeholder:text-xl w-full text-black mr-3 py-1 px-2 leading-tight focus:outline-none"
              placeholder="Email:"
              required
            />
          </div>
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="bg-red-400 font-bold rounded w-36 h-12 text-xl lg:w-56 lg:text-2xl lg:mt-4 mt-4"
          >
            Login
          </button>
        </div>
        ...
        <div className="hidden md:flex items-center gap-2">
          <p className="text-zinc-500 text-xl mr-4">Login with</p>
          <Link href=" " className="text-zinc-500 hover:text-grey-900">
            <svg
          ...
          <Link href=" " className="text-zinc-500 hover:text-grey-900 ml-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
