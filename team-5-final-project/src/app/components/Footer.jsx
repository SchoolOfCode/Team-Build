      ...
      <div className="flex flex-col items-center w-full my-20">
        ...
        <div className="flex flex-col items-center gap-6 mb-8">
          <div className="flex flex-wrap items-center justify-center gap-5 lg:gap-12 gap-y-3 lg:flex-nowrap text-dark-grey-900">
            ...
            <Link href="javascript:void(0)" className="text-gray-600 hover:text-gray-900">Features</Link>
            <Link href="javascript:void(0)" className="text-gray-600 hover:text-gray-900">Blog</Link>
            <Link href="jLinkvascript:void(0)" className="text-gray-600 hover:text-gray-900">Resources</Link>
            <Link href="javascript:void(0)" className="text-gray-600 hover:text-gray-900">Partners</Link>
            <Link href="javascript:void(0)" className="text-gray-600 hover:text-gray-900">Help</Link>
            <Link href="javascript:void(0)" className="text-gray-600 hover:text-gray-900">Terms</Link>
          </div>
          <div className="flex items-center gap-8">
            <Link href="javascript:void(0)" className="text-grey-700 hover:text-grey-900">
        ...
        <div className="flex items-center">
          <p className="text-base font-normal leading-7 text-center text-grey-700">
            2023 Build by School of Code. All rights reserved.</p>
        </div>
      </div>
    </div>
  </div>
