        ...
        <div className="justify-between mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
          ...
          <div>
            <div className={`absolute z-20 ${navbar ? "block" : "hidden"}`}>
              <ul className="flex flex-col text-md text-right p-4 ml-32 mr-6 gap-4 bg-zinc-100 w-60 font-bold text-xl mt-7 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] rounded-md">
                <li className="">
                  <Link href="/"></Link>{" "}
                </li>
                ...
                <li className="">
                  ...
                  <hr class="ml-32 mt-2 h-1 w-20 bg-emerald-400"></hr>
                </li>
                <li className="">
                ...
                <span className="flex justify-evenly items-center pt-16">
                  ...
                  <Link
                    href=" "
                    className="text-zinc-500 hover:text-grey-900 ml-1"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
                ...
                <hr class="ml-5 mt-1 h-1 w-44 bg-emerald-400"></hr>
              </ul>
            </div>
          </div>
        </div>
