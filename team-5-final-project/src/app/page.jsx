...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col justify-evenly ml-6 lg:flex lg:mx-40">
      <h1 className="leading-snug text-6xl font-bold lg:text-7xl lg:max-w-3xl lg:leading-snug">
      ...
      <div className="flex flex-col justify-between lg:flex lg:flex-row-reverse lg:align-bottom">
        <p className="text-3xl font-bold mb-10 lg:max-w-2xl lg:mr-24 lg:leading-snug">
