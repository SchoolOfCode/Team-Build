...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col justify-evenly ml-6 lg:flex lg:mx-40">
      ...
      <div className="flex flex-col justify-between lg:flex lg:flex-row-reverse lg:align-center">
        ...
        <button className="button bg-red-400 font-bold rounded w-44 mt-10 h-16 text-xl lg:w-56 lg:text-2xl">
